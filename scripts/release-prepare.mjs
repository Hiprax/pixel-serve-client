...
//
// Usage:
//   npm run release:prepare -- patch        # 1.1.6 -> 1.1.7
//   npm run release:prepare -- minor        # 1.1.6 -> 1.2.0
//   npm run release:prepare -- major        # 1.1.6 -> 2.0.0
//   npm run release:prepare -- 1.1.7-beta.1 # explicit version (no bump)
